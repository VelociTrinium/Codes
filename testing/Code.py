...
with open(r"D:\#Codes\testing\students.json", 'r') as f:
    students_data = json.load(f)

with open(r"D:\#Codes\testing\rooms.json", 'r') as f:
    rooms_data = json.load(f)

with open(r"D:\#Codes\testing\preferences.json", 'r') as f:
...
def save_allocation_to_json():
    ...
    with open(r"D:\#Codes\testing\allocation_results.json", 'w') as f:
